...
static const struct m68k_opcode m68k_opcodes[] =
{
	...
	{ "add.b",	2, 0050000, 0170700, "Qd$b" },
	{ "add.b",	4, 0003000, 0177700, "#b$s" },
	{ "add.b",	2, 0150000, 0170700, ";bDd" },
	{ "add.b",	2, 0150400, 0170700, "Dd~b" },
	{ "add.w",	2, 0050100, 0170700, "Qd%w" },
	{ "add.w",	2, 0150300, 0170700, "*wAd" },
	{ "add.w",	4, 0003100, 0177700, "#w$s" },
	{ "add.w",	2, 0150100, 0170700, "*wDd" },
	{ "add.w",	2, 0150500, 0170700, "Dd~w" },
	{ "add.l",	2, 0050200, 0170700, "Qd%l" },
	{ "add.l",	6, 0003200, 0177700, "#l$s" },
	{ "add.l",	2, 0150700, 0170700, "*lAd" },
	...
	{ "and.b",	4, 0001000, 0177700, "#b$s" },
	{ "and.b",	4, 0001074, 0177777, "#bCs" },
	{ "and.b",	2, 0140000, 0170700, ";bDd" },
	{ "and.b",	2, 0140400, 0170700, "Dd~b" },
	{ "and.w",	4, 0001100, 0177700, "#w$s" },
	{ "and.w",	4, 0001174, 0177777, "#wSs" },
	{ "and.w",	2, 0140100, 0170700, ";wDd" },
	{ "and.w",	2, 0140500, 0170700, "Dd~w" },
	{ "and.l",	6, 0001200, 0177700, "#l$s" },
	...
	{ "cmp.b",	4, 0006000, 0177700, "#b@s" },
	{ "cmp.b",	2, 0130410, 0170770, "+s+d" },
	{ "cmp.b",	2, 0130000, 0170700, ";bDd" },
	{ "cmp.w",	2, 0130300, 0170700, "*wAd" },
	{ "cmp.w",	4, 0006100, 0177700, "#w@s" },
	{ "cmp.w",	2, 0130510, 0170770, "+s+d" },
	{ "cmp.w",	2, 0130100, 0170700, "*wDd" },
	{ "cmp.l",	2, 0130700, 0170700, "*lAd" },
	{ "cmp.l",	6, 0006200, 0177700, "#l@s" },
	{ "cmp.l",	2, 0130610, 0170770, "+s+d" },
	...
	{ "eor.b",	4, 0005000, 0177700, "#b$s" },
	{ "eor.b",	4, 0005074, 0177777, "#bCs" },
	{ "eor.b",	2, 0130400, 0170700, "Dd$s" },
	{ "eor.w",	4, 0005100, 0177700, "#w$s" },
	{ "eor.w",	4, 0005174, 0177777, "#wSs" },
	{ "eor.w",	2, 0130500, 0170700, "Dd$s" },
	{ "eor.l",	6, 0005200, 0177700, "#l$s" },
	...
	{ "or.b",	4, 0000000, 0177700, "#b$s" },
	{ "or.b",	4, 0000074, 0177777, "#bCs" },
	{ "or.b",	2, 0100000, 0170700, ";bDd" },
	{ "or.b",	2, 0100400, 0170700, "Dd~s" },
	{ "or.w",	4, 0000100, 0177700, "#w$s" },
	{ "or.w",	4, 0000174, 0177777, "#wSs" },
	{ "or.w",	2, 0100100, 0170700, ";wDd" },
	{ "or.w",	2, 0100500, 0170700, "Dd~s" },
	{ "or.l",	6, 0000200, 0177700, "#l$s" },
	...
	{ "sub.b",	2, 0050400, 0170700, "Qd%s" },
	{ "sub.b",	4, 0002000, 0177700, "#b$s" },
	{ "sub.b",	2, 0110000, 0170700, ";bDd" },
	{ "sub.b",	2, 0110400, 0170700, "Dd~s" },
	{ "sub.w",	2, 0050500, 0170700, "Qd%s" },
	{ "sub.w",	4, 0002100, 0177700, "#w$s" },
	{ "sub.w",	2, 0110300, 0170700, "*wAd" },
	{ "sub.w",	2, 0110100, 0170700, "*wDd" },
	{ "sub.w",	2, 0110500, 0170700, "Dd~s" },
	{ "sub.l",	2, 0050600, 0170700, "Qd%s" },
	{ "sub.l",	6, 0002200, 0177700, "#l$s" },
	{ "sub.l",	2, 0110700, 0170700, "*lAd" },
